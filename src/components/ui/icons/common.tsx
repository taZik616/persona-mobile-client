...
export const GiftCardIcon = ({color = Color.primary, ...props}: SvgProps) => {
  return (
    <Svg width={20} height={20} viewBox="0 0 20 20" fill="none" {...props}>
      <Path
        fill={color}
        fillRule="evenodd"
        d="M6 8.168V9.31H4.857A1.143 1.143 0 1 1 6 8.168Zm-2.857 0a1.714 1.714 0 1 1 3.428 0 1.714 1.714 0 1 1 1.714 1.714H7.38l2.02 2.02-.404.405-2.424-2.425-2.424 2.425-.404-.405 2.02-2.02h-.906a1.714 1.714 0 0 1-1.714-1.714Zm4 0V9.31h1.142a1.143 1.143 0 1 0-1.142-1.143Z"
        clipRule="evenodd"
      />
      <Path
        fill={color}
        d="M11.185 14.998h.571v.571h-.571zM13.472 14.998h.571v.571h-.571zM15.757 14.998h.571v.571h-.571zM14.614 14.998h.571v.571h-.571zM12.328 14.998h.571v.571h-.571zM16.9 14.998h.571v.571H16.9zM11.185 5.375h.571v.571h-.571zM13.472 5.375h.571v.571h-.571zM15.757 5.375h.571v.571h-.571zM14.614 5.375h.571v.571h-.571zM12.328 5.375h.571v.571h-.571zM16.9 5.375h.571v.571H16.9zM11.185 6.518h.571v.571h-.571zM13.472 6.518h.571v.571h-.571zM14.614 6.518h.571v.571h-.571zM12.328 6.518h.571v.571h-.571z"
      />
      <Path
        fill={color}
        fillRule="evenodd"
        d="M18.286 3.428H6.857v2.74a.286.286 0 1 1-.571 0v-2.74H1.714c-.63 0-1.142.512-1.142 1.143v5.143h2.285c.158 0 .286.128.286.286v.286H.572v5.142c0 .632.511 1.143 1.142 1.143h4.572v-3.979a.286.286 0 1 1 .571 0v3.98h11.429c.63 0 1.143-.512 1.143-1.144v-5.143H10V10c0-.158.128-.286.286-.286h9.143V4.571c0-.631-.512-1.143-1.143-1.143ZM0 10.286v5.142c0 .947.768 1.715 1.714 1.715h16.572c.947 0 1.714-.768 1.714-1.715V4.571c0-.947-.767-1.714-1.714-1.714H1.714C.768 2.857 0 3.624 0 4.57v5.715Z"
        clipRule="evenodd"
      />
    </Svg>
  )
